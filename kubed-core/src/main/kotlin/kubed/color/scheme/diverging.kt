...
fun schemeBrBG(k: Int = 11) = scheme(k, BrBG)
fun schemePRGn(k: Int = 11) = scheme(k, PRGn)
fun schemePiYG(k: Int = 11) = scheme(k, PiYG)
fun schemePuOr(k: Int = 11) = scheme(k, PuOr)
fun schemeRdBu(k: Int = 11) = scheme(k, RdBu)
fun schemeRdGy(k: Int = 11) = scheme(k, RdGy)
fun schemeRdYlBu(k: Int = 11) = scheme(k, RdYlBu)
